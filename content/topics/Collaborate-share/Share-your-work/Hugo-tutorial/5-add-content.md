...
## Session 1: Adding an About Page to your Hugo Site (Ananke Theme)
...
Given that you have defined a default archetype this will create a file at `content/about.md` with some default front matter:
...
## Session 2: Adding an Image to a Page in Hugo (Ananke Theme)
...
For example, if you have an image called `profile.jpg`, place it in:
```
my-hugo-site/`static`/images/profile.jpg
```

### Step 2: Reference the Image in Your Markdown File
Now edit your content file (e.g., `content/about.md) and use standard Markdown to insert the image:
```markdown
&lt;markdown&gt;![My Profile Picture](/images/profile.jpg)&lt;/markdown&gt;
```
...
## Session 3: Adding a Table in Markdown (Hugo + Ananke Theme)
