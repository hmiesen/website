...
aliases:
  ...
  - /topics/project-management/principles-of-project-setup-and-workflow-management/versioning
---
...
**Git** is an [open-source version control system](/topics/configure-your-computer/statistics-and-computation/git/), which allows you to keep track
