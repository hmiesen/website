...
title: "Part 2: Verify Software Setup"
...
Before we're getting started, let's verify whether you have properly followed our [setup guide](../../../../../topics/computer-setup/software-installation/introduction/software-setup-overview) for R, Python and `make` in order to be able to run our workflow.
